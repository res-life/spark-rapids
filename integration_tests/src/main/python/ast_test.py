...
from spark_session import with_cpu_session, is_spark_359, is_spark_403, is_spark_412_or_later
...
# Spark 4.0.3, and Spark 4.1.2+.
ast_acosh_descr = [(
    double_gen, not (is_spark_359() or is_spark_403() or is_spark_412_or_later()))]
